    ...
    <div className="page-shell">
      <div className="page-container py-10 lg:py-14">
        <div className="mb-8">
          ...
          <h1 className="section-title mt-2">Browse Cars</h1>

          <p className="section-copy">
            Find privately listed cars using search and filters.
          </p>
        </div>

        <div className="surface mb-8 p-5 sm:p-6">
          <div className="mb-5">
            <h2 className="font-bold">Find your next car</h2>
            <p className="mt-1 text-sm text-gray-500">
              Search by brand, model, variant or city.
            </p>
          </div>
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <input
              ...
              placeholder="Brand, model, variant or city"
          ...
          <div className="mt-5 flex flex-wrap items-center justify-between gap-4 border-t border-gray-100 pt-4">
            <p className="text-sm text-gray-500">
              {pagination ? `${pagination.totalCars} cars found` : ""}
            </p>
        ...
        {loading ? (
          <div className="surface p-10 text-center text-sm text-gray-500">
            Loading cars...
          </div>
        ) : error ? (
          ...
          <div className="surface p-12 text-center">
            <h2 className="font-semibold">No cars found</h2>
        ...
        {pagination && pagination.totalPages > 1 && (
          <div className="mt-10 flex items-center justify-center gap-4">
            <button
              ...
              className="secondary-button text-sm disabled:cursor-not-allowed disabled:opacity-40"
            >
              Previous
            </button>
