...
const getMe = async (req, res) => {
  try {
    const user = await User.findById(req.user.userId).select("name email role subscriptionPlan subscriptionStatus subscriptionId subscriptionExpiresAt subscriptionCancelAtCycleEnd verificationStatus verifiedAt createdAt");
